// O SVG usado em arquivos HTML é diferente do usado em JSX, por isso usamos o site (https://transform.tools) para converter o SVG copiado do figma para um SVG no formato correto do JSX
